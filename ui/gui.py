...
#
# Created: Mon Feb  2 20:00:43 2015
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkBox_plotShowing.setGeometry(QtCore.QRect(970, 440, 101, 41))
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(9, -1, 1161, 441))
        ...
        self.verticalLayout_5.addWidget(self.histogram_widget)
        self.label_5 = QtGui.QLabel(self.horizontalLayoutWidget)
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.verticalLayout_5.addWidget(self.label_5)
        self.fitnes_widget = PlotWidget(self.horizontalLayoutWidget)
        self.fitnes_widget.setObjectName(_fromUtf8("fitnes_widget"))
        self.verticalLayout_5.addWidget(self.fitnes_widget)
        ...
        self.table_axes.setColumnCount(3)
        ...
        self.table_axes.horizontalHeader().setDefaultSectionSize(115)
        ...
        self.checkBox_logging.setGeometry(QtCore.QRect(1080, 450, 61, 26))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "Fitness", None))
        self.label.setText(_translate("MainWindow", "Plot settings", None))
